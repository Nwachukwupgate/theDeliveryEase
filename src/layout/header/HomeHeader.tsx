  ...
  return (
    <nav className={`${isOpen ? 'bg-primaryHoverColorDark' : 'bg-white'}  opacity-100 shadow fixed top-0 w-full z-50`}>
      <div className="container px-6 py-6 mx-auto md:flex md:justify-between md:items-center">
        ...
        <div className={`h-screen bg-primaryHoverColorDark opacity-80 md:hidden absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:items-center ${isOpen ? 'block opacity-100 translate-x-0' : 'hidden opacity-0 -translate-x-full'}`}>
