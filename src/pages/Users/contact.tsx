...
const ContactPage = () => {
  // Remove spaces and "+" from phone number for wa.me link
  const whatsappLink = `https://wa.me/${customerNo.replace(/\D/g, "")}`;
          ...
          <div className="w-full flex flex-col lg:flex-row justify-between gap-6 my-10">
            <div className="flex-1 bg-white p-8">
              ...
              <div className='space-y-2'>
                ...
                <p className='font-semibold'>support@thedeliveryeaselogistics.com</p>
              </div>
            </div>
            ...
            <div className="flex-1 bg-white p-8">
              ...
              <div className='space-y-2'>
                ...
                <p className='font-semibold'>{customerNo} | 08035327006</p>
              </div>
            </div>
          </div>
        </div>
